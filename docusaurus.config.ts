...
const config: Config = {
  ...
  organizationName: 'MockbaBot', // Usually your GitHub org/user name.
  projectName: 'MockbaManual', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} GlobalDv, C.A. Built with Docusaurus.`,
    },
    prism: {
